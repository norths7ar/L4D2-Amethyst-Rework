/**
 * Coop integration of Tabun Skill Detect and Rework Realtime Stats.
 * Hunter classification lives in hunter.sp; resolved kill events drive chat,
 * healing and sounds. Legacy informational forwards remain for existing consumers.
 */
#pragma semicolon 1
...
*****************************************************************/
#define COOP_SKILL_DETECT_IMPL
#include <coop_skill_detect>
#include "skill_detect/hunter.sp"
#include "skill_detect/events.sp"
#include "skill_detect/tracking.sp"
#include "skill_detect/report.sp"
	...
	AskPluginLoad2(Handle myself, bool late, char[] error, int err_max)
{
	...
	RegPluginLibrary("coop_skill_detect");
	CreateNative("Skill_ReportJockeySkeet", Native_ReportJockeySkeet);
	g_KillForward = new GlobalForward("OnSkillKillResolved", ET_Ignore, Param_Cell, Param_Cell, Param_Cell, Param_Cell, Param_Cell, Param_String, Param_Cell);
...
void OnHookEvent()
{
	...
	HookEvent("player_death", SkillDeath, EventHookMode_Post);
	HookEvent("weapon_fire", HunterWeaponFire, EventHookMode_Pre);
