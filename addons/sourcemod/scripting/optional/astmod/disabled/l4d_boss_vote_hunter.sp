...
public Plugin myinfo =
{
	...
	description = "Votin for boss change. 删除 readyup 和 rounds 相关",
	...
	for (int i=0; i<num_items; i++)
	{
		if (item_info[i][BUILTINVOTEINFO_ITEM_INDEX] == BUILTINVOTES_VOTE_YES)
		{
			...
			{	
				...
				SetConVarInt(FindConVar("l4d_multiwitch_spawnfreq"), bv_iWitch);
...
public Action ForceWitchCommand(int client, int args)
{
	...
	SetConVarInt(FindConVar("l4d_multiwitch_spawnfreq"), p_iRequestedPercent);
